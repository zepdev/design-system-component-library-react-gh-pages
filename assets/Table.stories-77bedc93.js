import{j as t,c as m}from"./clsx-36b9529f.js";import{c as j}from"./index-24fb42db.js";import{r as te}from"./index-8b3efc3f.js";import{a as oe,F as le}from"./Icon-744794d1.js";import{Z as pe,a as ce}from"./ZpsButton-e305ea0f.js";import{t as w}from"./tw-merge-1166cefb.js";import{B as ue,a as V}from"./Button-50673b6e.js";import"./_commonjsHelpers-de833af9.js";import"./Spacing-3ed1191f.js";var e=(a=>(a.Zps="ZPS",a.Cat="CAT",a.Zsd="ZSD",a.Default="Default",a))(e||{}),x=(a=>(a.Text="text",a.Button="button",a))(x||{});const ae=te.createContext({variant:e.Zps}),F=()=>te.useContext(ae),de=({children:a,...s})=>t.jsx("tbody",{...s,children:a}),me=({children:a,className:s,isFirstRow:n,align:c,...u})=>{const{variant:i}=F(),d={[e.Zps]:["zep-text-typography-primary-default "],[e.Cat]:["zep-text-typography-dark-100"],[e.Zsd]:["zep-text-typography-dark-100"],[e.Default]:["zep-text-typography-dark-100"]},z=j([`
    zep-inline-block
    zep-text-right
    sm:zep-text-unset
    sm:zep-py-0.5
