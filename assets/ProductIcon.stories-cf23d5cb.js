import{j as e}from"./clsx-667af910.js";import{P as z,b as x}from"./Icon-1c0b3313.js";import{S as o}from"./Spacing-986d89c6.js";import"./index-37ba2b57.js";import"./_commonjsHelpers-de833af9.js";import"./index-47d55b97.js";const w={title:"General/Icons/ProductIcon",tags:["autodocs"],component:z,argTypes:{name:{control:{type:"select",options:[typeof x]}}},parameters:{controls:{exclude:["size"]}}},a={args:{name:"hook",role:"img"}},s={args:{name:"hook",role:"img",className:"zep-text-error"}},y=(r,h)=>r.localeCompare(h),b=Object.keys(x).sort(y),c={args:{name:"hook"},decorators:[()=>e.jsx(e.Fragment,{children:e.jsx(o,{direction:"column",gap:"2",children:e.jsxs(o,{direction:"column",gap:"1",children:[e.jsx("h3",{className:"zep-font-500",children:"Product Icons (56px)"}),e.jsx(o,{gap:"1",children:b.map(r=>e.jsxs(o,{direction:"column",justifyContent:"between",className:"zep-h-[185px] zep-w-[185px] zep-border-1 zep-border-greyscale-700 zep-bg-greyscale-100",children:[e.jsx(o,{justifyContent:"center",alignItems:"center",className:"zep-grow",children:e.jsx(z,{name:r})}),e.jsx("span",{className:"zep-border-t-1 zep-border-greyscale-700 zep-bg-greyscale-0 zep-p-0.25 zep-text-0.875",children:r})]},r))})]})})})]};var n,t,p;a.parameters={...a.parameters,docs:{...(n=a.parameters)==null?void 0:n.docs,source:{originalSource:`{
  args: {
    name: 'hook',
    role: 'img'
  }
...
//# sourceMappingURL=ProductIcon.stories-cf23d5cb.js.map
