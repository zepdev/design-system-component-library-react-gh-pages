import{j as a}from"./clsx-667af910.js";import{w as _e,e as s,u as i}from"./index-36a8f999.js";import{r as b}from"./index-37ba2b57.js";import{I as n}from"./Input-51d7405e.js";import{S as d}from"./Spacing-a8401166.js";import{B as c}from"./Button-afdfbeb4.js";import{F as Ge}from"./Fieldset-15c054e0.js";import"./_commonjsHelpers-de833af9.js";import"./_baseIsEqual-976d9d82.js";import"./index-03bbf7d1.js";import"./uniq-9fca3600.js";import"./index-356e4a49.js";import"./focus-d7245c50.js";import"./Icon-58810b29.js";import"./index-47d55b97.js";import"./tw-merge-1166cefb.js";const da={title:"Components/Input",component:n,tags:["autodocs"],decorators:[e=>a.jsx("div",{className:"zep-w-[326px] [&>*]:zep-w-full",children:a.jsx(e,{})})],argTypes:{label:{control:{type:"text"}},type:{control:{type:"select",options:["text","search","number","date","password"]}},disabled:{control:{type:"boolean"}},required:{control:{type:"boolean"}},notRequiredHint:{control:{type:"text"}},readOnly:{control:{type:"boolean"}},error:{control:{type:"boolean"}},hasInfoIcon:{control:{type:"boolean"}},placeholder:{control:{type:"text"}}}},p={args:{id:"id-default",placeholder:"Placeholder",name:"input",type:"text",label:"Label",disabled:!1,required:!1,notRequiredHint:"(optional)",readOnly:!1,error:!1,onChange:e=>{console.log(e.target.value)}},render:(e,t)=>a.jsx(n,{placeholder:e.placeholder,...e}),play:async({canvasElement:e,step:t})=>{const r=_e(e).getByTestId("zep-input-field");await t("Initial checks",async()=>{await s(r).toBeInTheDocument(),await s(r).not.toHaveFocus()}),await t("Check inputField focus via Keyboard",async()=>{await i.tab(),await s(r).toHaveFocus()}),await t("Fill inputField with keyboard and check value",async()=>{await i.type(r,"Test value"),await s(r).toHaveValue("Test value")}),await t("Clear inputField with keyboard and check value",async()=>{await i.clear(r),await i.type(r,"New test value"),await s(r).toHaveValue("New test value")}),await t("Click inputField and check focus",async()=>{await i.click(r),await s(r).toHaveFocus()}),await t("Blur inputField with keyboard and check focus",async()=>{await i.tab(),await s(r).not.toHaveFocus()})}},y={decorators:[e=>{const[t,o]=b.useState("Prefilled");return a.jsx(e,{value:t,setValue:o})}],args:{id:"id-search",name:"input",type:"search",disabled:!1,label:"Label",placeholder:"Placeholder",required:!1,notRequiredHint:"(optional)"},render:(e,t)=>{const{value:o,setValue:r}=t;return a.jsx(n,{autoFocus:!0,placeholder:e.placeholder,...e,value:o,onChange:l=>{r(l.target.value)}})}},v={args:{id:"id-number",name:"input",type:"number",label:"Label",disabled:!1,error:!1,placeholder:"Placeholder",required:!1,notRequiredHint:"(optional)",onChange:e=>{console.log(e.target.value)}}},x={args:{id:"id-date",name:"input",type:"date",label:"Label",disabled:!1,error:!1,placeholder:"Placeholder",required:!1,notRequiredHint:"(optional)",onChange:e=>{console.log(e.target.value)}}},q={decorators:[e=>{const[t,o]=b.useState("TopSecret"),[r,l]=b.useState("hide");return a.jsx(e,{value:t,setValue:o,icon:r,setIcon:l})}],args:{id:"id-password",label:"Label",name:"input",disabled:!1,required:!1,notRequiredHint:"(optional)"},render:(e,t)=>{const{value:o,setValue:r,icon:l,setIcon:u}=t;return a.jsx(n,{type:l==="hide"?"password":"text",icon:l,placeholder:e.placeholder,...e,value:o,onIconToggle:()=>{u(l==="hide"?"show":"hide")},onChange:f=>{r(f.target.value)}})}},S={args:{id:"id-disabled",name:"text",type:"number",label:"Label",disabled:!0,error:!1,placeholder:"Placeholder",required:!1,notRequiredHint:"(optional)",onChange:e=>{console.log(e.target.value)}}},m={args:{id:"id-hint-message",placeholder:"Placeholder",name:"input",type:"text",label:"Label",disabled:!1,required:!1,notRequiredHint:"(optional)",readOnly:!1,error:!1,onChange:e=>{console.log(e.target.value)}},render:(e,t)=>a.jsx(n,{message:"Hint message",placeholder:e.placeholder,...e})},g={args:{id:"id-info-message",placeholder:"Placeholder",name:"input",type:"text",label:"Label",disabled:!1,required:!1,notRequiredHint:"(optional)",readOnly:!1,error:!1,onChange:e=>{console.log(e.target.value)}},render:(e,t)=>a.jsx(n,{message:"Info message",state:"info",placeholder:e.placeholder,...e})},h={args:{id:"id-error-message",name:"input",type:"text",label:"Label",disabled:!1,error:!0,placeholder:"Placeholder",required:!1,notRequiredHint:"(optional)",onChange:e=>{console.log(e.target.value)}},render:(e,t)=>a.jsx(n,{message:"Some error message",state:"error",placeholder:e.placeholder,...e})},I={args:{id:"id-readonly",name:"input",type:"text",label:"Label",value:"Filled",readOnly:!0,placeholder:"Placeholder",required:!1,notRequiredHint:"(optional)",onChange:e=>{}}},w={args:{id:"id-more-info",name:"input",type:"text",label:"Label",placeholder:"Placeholder",hasInfoIcon:!0,infoTitle:"More information",required:!1,notRequiredHint:"(optional)",onIconInfoClick:()=>{alert("Info icon clicked")}}},H={args:{id:"id-autocomplete",name:"name",type:"text",label:"Name",placeholder:"Enter your name",disabled:!1,error:!1,autoComplete:"name",required:!1,notRequiredHint:"(optional)",onChange:e=>{console.log(e.target.value)}},render:(e,t)=>a.jsx(n,{message:"Click this field. A dropdown menu should appear with the names already entered",placeholder:e.placeholder,...e})},C={args:{id:"id-required-validation",name:"input",type:"text",label:"Label",placeholder:"Placeholder",required:!0,notRequiredHint:"(optional)",disabled:!1,error:!1,onInvalid:()=>console.log("Invalid"),onChange:e=>{console.log(e.target.value)}},render:(e,t)=>a.jsx("form",{children:a.jsxs(d,{direction:"column",gap:"1",children:[a.jsx(n,{message:"Should validate empty field once button is clicked",placeholder:e.placeholder,...e}),a.jsx(c,{type:"submit",children:"Submit"})]})})},F={args:{id:"id-custom-validation-message",name:"input",type:"text",label:"Label",notRequiredHint:"(optional)",placeholder:"Placeholder",required:!0,disabled:!1,error:!1,onInvalid:e=>e.target.setCustomValidity("My validation message"),onChange:e=>{console.log(e.target.value)}},render:(e,t)=>a.jsx("form",{children:a.jsxs(d,{direction:"column",gap:"1",children:[a.jsx(n,{message:"Should validate empty field once button is clicked",placeholder:e.placeholder,...e}),a.jsx(c,{type:"submit",children:"Submit"})]})})},R={args:{id:"id-email-validation",name:"input",type:"email",label:"Email",placeholder:"Placeholder",required:!0,notRequiredHint:"(optional)",disabled:!1,error:!1,onChange:e=>{console.log(e.target.value)}},render:(e,t)=>a.jsx("form",{children:a.jsxs(d,{direction:"column",gap:"1",children:[a.jsx(n,{message:"Should validate email once button is clicked",placeholder:e.placeholder,...e}),a.jsx(c,{type:"submit",children:"Submit"})]})})},j={args:{id:"id-pattern-validation",name:"input",type:"text",label:"Label",placeholder:"Placeholder",pattern:"[a-z]{4,20}",required:!0,notRequiredHint:"(optional)",disabled:!1,error:!1,onChange:e=>{console.log(e.target.value)}},render:(e,t)=>a.jsx("form",{children:a.jsxs(d,{direction:"column",gap:"1",children:[a.jsx(Ge,{message:"Only lowercase. Enter at least 4 chars and max 20.",children:a.jsx(n,{placeholder:e.placeholder,...e})}),a.jsx(c,{type:"submit",children:"Submit"})]})})},L={args:{id:"id-min-max-validation",name:"input",type:"text",label:"Label",placeholder:"Placeholder",minLength:"8",maxLength:"12",required:!0,notRequiredHint:"(optional)",disabled:!1,error:!1,onChange:e=>{console.log(e.target.value)}},render:(e,t)=>a.jsx("form",{children:a.jsxs(d,{direction:"column",gap:"1",children:[a.jsx(n,{message:"Enter at least 8 chars. You cannot enter more than 12.",placeholder:e.placeholder,...e}),a.jsx(c,{type:"submit",children:"Submit"})]})})},k={decorators:[e=>{const[t,o]=b.useState("Should validate empty field once button is clicked"),[r,l]=b.useState("default");return a.jsx("form",{children:a.jsxs(d,{direction:"column",gap:"1",children:[a.jsx(e,{message:t,setMessage:o,state:r,setState:l}),a.jsx(c,{type:"submit",children:"Submit"})]})})}],args:{id:"id-aria-describedby",placeholder:"Placeholder",label:"Label",required:!0,notRequiredHint:"(optional)",disabled:!1,error:!1,type:"text",name:"input"},render:(e,t)=>{const{message:o,setMessage:r}=t,{state:l,setState:u}=t;return a.jsx(Ge,{message:o,messageId:"message-element-id",messageAriaLive:"assertive",state:l,children:a.jsx(n,{"aria-describedby":"message-element-id",placeholder:e.placeholder,...e,onInvalid:f=>{f.preventDefault(),r(f.target.validationMessage),u("error")},onChange:()=>{l==="error"&&(r("Should validate empty field once submit is clicked and field is empty."),u("default"))}})})}},V="zep-input-field",P={args:{label:"Label",required:!0,notRequiredHint:"(optional)"},render:(e,t)=>a.jsx(n,{id:"id-interaction-test",name:"input",type:"text",label:e.label,placeholder:"Placeholder",required:e.required,notRequiredHint:e.notRequiredHint,onChange:()=>{}}),play:async({canvasElement:e})=>{const t=_e(e);await i.click(t.getByTestId(V)),await i.type(t.getByTestId(V),"example-value",{delay:20}),await s(t.getByTestId(V)).toHaveValue("example-value")}};var E,M,B,T,D;p.parameters={...p.parameters,docs:{...(E=p.parameters)==null?void 0:E.docs,source:{originalSource:`{
  args: {
    id: 'id-default',
...
}`,...($=(Z=S.parameters)==null?void 0:Z.docs)==null?void 0:$.source}}};var ee,ae,te,re,ne;m.parameters={...m.parameters,docs:{...(ee=m.parameters)==null?void 0:ee.docs,source:{originalSource:`{
  args: {
    id: 'id-hint-message',
    placeholder: 'Placeholder',
    name: 'input',
...
}`,...(te=(ae=m.parameters)==null?void 0:ae.docs)==null?void 0:te.source},description:{story:"Here the Input component is used inside a FormField component to enable the use of a hint.",...(ne=(re=m.parameters)==null?void 0:re.docs)==null?void 0:ne.description}}};var oe,le,se,ie,de;g.parameters={...g.parameters,docs:{...(oe=g.parameters)==null?void 0:oe.docs,source:{originalSource:`{
  args: {
    id: 'id-info-message',
    placeholder: 'Placeholder',
    name: 'input',
...
}`,...(Ye=(Ke=P.parameters)==null?void 0:Ke.docs)==null?void 0:Ye.source}}};const ca=["Default","Search","Number","Date","Password","Disabled","HintMessage","InfoMessage","ErrorMessage","Readonly","InfoIcon","Autocomplete","RequiredValidation","CustomValidationMessage","EmailValidation","PatternValidation","MinMaxValidation","AriaDescribedby","FillValue"];export{k as AriaDescribedby,H as Autocomplete,F as CustomValidationMessage,x as Date,p as Default,S as Disabled,R as EmailValidation,h as ErrorMessage,P as FillValue,m as HintMessage,w as InfoIcon,g as InfoMessage,L as MinMaxValidation,v as Number,q as Password,j as PatternValidation,I as Readonly,C as RequiredValidation,y as Search,ca as __namedExportsOrder,da as default};
//# sourceMappingURL=Input.stories-7679aefd.js.map
